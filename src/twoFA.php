...
<div class="row " style="height:100%; width: 99%;">
    <div class="col-md-6 hidden-phone regLeft"
         style="background:#<?php echo $_SESSION["companysettings.mainColor"]; ?>">
        <div class="row">
            <div class="col-md-5">
    ...
    <div class="col-md-6 col-sm-12 regRight"
         style="box-shadow: -2px 0px 2px #494949; padding-top:14%; border-left: 1px solid #ddd;">
                ...
                <div class="regcontent" style="margin-left: 90px;">
                    <form id="login" action="<?php echo BASE_URL."/index.php?twoFA=1&redirectUrl=$redirectUrl" ?>" method="post">
                        ...
                        <div class="">
                            ...
                            <input type="submit" name="login" value="<?php echo $language->__("buttons.login"); ?>"
